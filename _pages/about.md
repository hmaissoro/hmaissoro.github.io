...
profile:
  ...
  more_info: >
    <p>Greater Paris Metropolitan Region</p>
...
My thesis, carried out at [CREST](https://crest.science/) and the data science consultancy [DataStorm](https://www.datastorm.fr/la-these-dhassan-maissoro-sur-les-donnees-fonctionnelles/), focused on **adaptive estimation for weakly dependent functional time series** with irregular sample paths, under the supervision of [Valentin Patilea](https://ensai.fr/equipe/valentin-patilea/) and [Myriam Vimond](https://ensai.fr/equipe/myriam-vimond/).
